...
function M.setup_organise_imports() --{{{
  nnoremap("<leader>ci", M.lsp_organise_imports, "Organise imports")
end --}}}

function M.document_formatting() --{{{
  nnoremap("<leader>cf", vim.lsp.buf.format, "Format buffer")
end --}}}
...
function M.implementation() --{{{
  ...
  nnoremap("gI", perform, "Go to implementation")
end --}}}
...
function M.code_action() --{{{
  ...
  nnoremap("<leader>ca", code_action, "Code action")
  xnoremap("<leader>ca", ":'<,'>CodeAction<CR>", "Code action")
end --}}}
...
function M.support_commands() --{{{
  ...
  nnoremap("<leader>lr", restart_lsp, "Restart LSP server")

  ...
  config = function()
    ...
    gs.setup({
      ...
      on_attach = function(bufnr) -- {{{
        ...
        vim.keymap.set("n", "<leader>ghs", function() gs.stage_hunk() end, { desc = "stage hunk" })
        vim.keymap.set("n", "<leader>ghu", function() gs.undo_stage_hunk() end, { desc = "undo last staged hunk" })
        vim.keymap.set("n", "<leader>ghr", function() gs.reset_hunk() end, { desc = "reset hunk" })
        vim.keymap.set("n", "<leader>ghR", function() gs.reset_buffer() end, { desc = "reset buffer" })
        vim.keymap.set("n", "<leader>ghp", function() gs.preview_hunk() end, { desc = "preview hunk" })
        vim.keymap.set("n", "<leader>ghl", function() gs.stage_hunk({ vim.fn.line("."), vim.fn.line(".") }) end, { desc = "stage line" })
        vim.keymap.set("x", "<leader>ghs", function() gs.stage_hunk({ vim.fn.line("."), vim.fn.line(".") }) end, { desc = "stage line" })
        vim.keymap.set("x", "<leader>ghr", function() gs.reset_hunk({ vim.fn.line("."), vim.fn.line(".") }) end, { desc = "reset line" })

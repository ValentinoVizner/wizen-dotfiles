...
return {
  ...
  ["akinsho/bufferline.nvim"] = { enabled = false, start = true },
  ["kdheepak/lazygit.nvim"] = { enabled = true, start = true },
  ["anuvyklack/hydra.nvim"] = { enabled = true, start = true },
  ["gen740/SmoothCursor.nvim"] = { enabled = true, start = true },
  ["cshuaimin/ssr.nvim"] = { enabled = true, start = true },
  ["folke/todo-comments.nvim"] = { enabled = true, start = true },
  ["folke/flash.nvim"] = { enabled = true, start = true },
  ["ThePrimeagen/haproon"] = { enabled = true, start = true },
  ["Rawnly/gist.nvim"] = { enabled = true, start = true },
  ["nvim-pack/nvim-spectre"] = { enabled = true, start = true },
  ["ThePrimeagen/refactoring.nvim"] = { enabled = true, start = true },
